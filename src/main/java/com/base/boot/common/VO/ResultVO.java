package com.base.boot.common.VO;
...
public final class ResultVO implements Serializable {
     ...
     * @return
     */
    public final static Map<String, Object> success(String jwtToken) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("jwtToken", jwtToken);
        map.put("code", ResultEnum.SUCCESS.getCode());
        map.put("message", ResultEnum.SUCCESS.getMessage());
    ...
    //
    public final static Map<String, Object> success(String key, Object data) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("code", ResultEnum.SUCCESS.getCode());
        map.put("message", ResultEnum.SUCCESS.getMessage());
        map.put(key, data);
